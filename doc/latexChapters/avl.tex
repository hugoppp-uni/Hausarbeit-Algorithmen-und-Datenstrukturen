...
\begin{figure}[hbt]
    ...
    \subfloat[Korrekt]{
        \includegraphics[width=.95\linewidth]{img/AVL_Tree_Rebalancing}
        \label{fig:AVL-Cases}}
    \end{minipage}
    \begin{minipage}[c]{.45\textwidth}
    \subfloat[Falsch]{
        \includegraphics[width=.95\linewidth]{img/AVL_Tree_Rebalancing_wrong.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width= 0.75\textwidth]{img/insert}
    \caption{InsertBT}
    \label{fig:AVL-insert}
\end{figure}
\begin{figure}[p]
    \centering
    \includegraphics[height= 0.97\textheight]{img/delete}
    \caption{DeleteBT}
...
\begin{figure}[p]
    \centering
    \includegraphics[width = 0.85\textwidth]{img/rebalance}
    \caption{Rebalancierung}
    \label{fig:rebalance}
\end{figure}
...
\begin{figure}[p]
    \centering
    \subfloat[\centering Links]{\includegraphics[width = 0.3\textwidth]{img/rotateL.pdf}}
    \subfloat[\centering Rechts]{\includegraphics[width = 0.3\textwidth]{img/rotateR.pdf}}
    \caption{Rotieren}
    \label{fig:rotate}
\end{figure}
...
\begin{figure}[hbtp]
    \centerline{\includegraphics[width = 1.2\textwidth]{img/1_6_before.pdf}}
