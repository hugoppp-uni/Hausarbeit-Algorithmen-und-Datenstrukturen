...
\begin{figure}[p]
    \centering
    \subfloat[\centering Links]{\includegraphics[width = 0.3\textwidth]{img/gv/rotateL.pdf}}
    \subfloat[\centering Rechts]{\includegraphics[width = 0.3\textwidth]{img/gv/rotateR.pdf}}
    \caption{Rotieren}
    \label{fig:rotate}
\end{figure}
